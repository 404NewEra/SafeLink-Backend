...
class FallbackAdviceGenerator:
    ...
    def generate(
        ...
        recommendations = {
            "safe": "현재 위험 신호는 낮지만 기상 정보를 주기적으로 확인하세요.",
            "interest": "기상 변화와 재난 알림을 확인하고 위험 지역 정보를 미리 살펴보세요.",
            "caution": "비탈면과 하천 주변 접근을 줄이고 대피 준비물을 점검하세요.",
            "danger": "외출을 자제하고 지자체 안내에 따라 대피할 준비를 하세요.",
            "very_danger": "즉시 위험 지역을 벗어나 가까운 대피소로 이동하고 공식 안내를 따르세요.",
        }
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                (
                    ...
                    "행동 추천은 주의사항과 즉시 해야 할 행동을 먼저 설명하고, "
                    "그 다음에 검색된 대피소를 입력된 순서대로 안내하세요. "
                    "과거 재난을 현재 발생 사실처럼 "
